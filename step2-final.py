...
if __name__ == '__main__':
    ...
    model_path = '/home/shea.durgin/netstore1/final_distilroberta_results'
    ...
    if 'train' in sys.argv:
        ...
        json_name = 'no_ft_final_results.json'
